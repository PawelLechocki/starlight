...
export default async function add(_value, _a_newOwnerPublicKey = 0) {
	...
	const instance = await getContractInstance("WWWShield");

	const contractAddr = await getContractAddress("WWWShield");
	...
	if (!fs.existsSync(keyDb))
		await registerKey(utils.randomHex(31), "WWWShield", false);
